...
public class Temp_CalendarEventService
{
    ...
    {
        new Temp_CalendarEvent(Guid.NewGuid(), "Very important event", null,
        DateTime.UtcNow,
        DateTime.UtcNow.AddDays(-3).AddHours(4),
        DateTime.UtcNow),

        new Temp_CalendarEvent(Guid.NewGuid(), "Making this project", null,
        new DateTime(2022, 1, 3, 15, 00, 00, DateTimeKind.Utc),
        DateTime.UtcNow.AddDays(100),
        DateTime.UtcNow),

        new Temp_CalendarEvent(Guid.NewGuid(), "Wake up", null,
        ...
        new Temp_CalendarEvent(Guid.NewGuid(), "My Birthday", null,
        ...
        new Temp_CalendarEvent(Guid.NewGuid(), "Knowledge day", null,
