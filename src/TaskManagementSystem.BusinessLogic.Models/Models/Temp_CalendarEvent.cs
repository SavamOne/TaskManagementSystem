...
{
    public Temp_CalendarEvent(Guid eventId, string name, string? description, DateTime utcStartTime, DateTime utcEndTime, DateTime utcCreationTime)
    {
        EventId = eventId;
    ...
    public Temp_CalendarEvent(Guid eventId, string name, string? description, DateTime utcStartTime, DateTime utcEndTime, DateTime utcCreationTime, Temp_RecurrentEventSettings recurrentSettings)
    {
        EventId = eventId;
        Name = name.AssertNotNullOrWhiteSpace();
        Description = description;
